...
export const en_US: ObjectType = {
	...
	margeTableCellsLeft: 'Merge cells to the left',
	margeTableCellsRight: 'Merge cells to the right',
	margeTableCellsUp: 'Merge cells up',
	margeTableCellsDown: 'Merge cells down',
