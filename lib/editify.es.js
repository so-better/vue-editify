...
const getLinkText = (dataRangeCaches) => {
  let text = "";
...
const Triangle = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-0459de89"]]);
const LayerProps = {
  //是否显示
  modelValue: {
    type: Boolean,
...
const Layer = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-7372b7b9"]]);
const TooltipProps = {
  //提示内容
  content: {
    type: String,
...
const Tooltip = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-1e4667f7"]]);
const IconProps = {
  //图标值
  value: {
    type: String,
...
const Icon = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-ce86a122"]]);
const ButtonProps = {
  //按钮类型
  type: {
    type: String,
...
const Button = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-e6e3ed60"]]);
const CheckboxProps = {
  //是否禁用
  disabled: {
    type: Boolean,
...
const Checkbox = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-7136ea52"]]);
const ColorsProps = {
  //颜色数组
  data: {
    type: Array,
...
const Colors = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-1f31fb83"]]);
const ToolbarProps = {
  //是否显示
  modelValue: {
    type: Boolean,
...
const Toolbar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-3b5e9e89"]]);
...
const InsertLink = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9cc54e3f"]]);
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        if (!isMatch) {
          if (typeof props.handleError == "function") {
            props.handleError.apply(instance.proxy, ["suffixError", file2]);
          }
          continue;
        }
        if (props.maxSize && file2.size / 1024 > props.maxSize) {
          if (typeof props.handleError == "function") {
            props.handleError.apply(instance.proxy, ["maxSizeError", file2]);
          }
          continue;
        }
        if (props.minSize && file2.size / 1024 < props.minSize) {
          if (typeof props.handleError == "function") {
            props.handleError.apply(instance.proxy, ["minSizeError", file2]);
          }
          continue;
        }
...
const InsertImage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-638717b7"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const selectFile = async (e) => {
      ...
      if (filterFiles.length) {
        let videos = [];
        if (typeof props.customUpload == "function") {
          videos = await props.customUpload.apply(instance.proxy, [filterFiles]) || [];
        } else {
          for (let i = 0; i < filterFiles.length; i++) {
            const url = await file.dataFileToBase64(filterFiles[i]);
            videos.push(url);
...
const InsertVideo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-011f9a6b"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-f60fb752"), n = n(), popScopeId(), n);
...
const InsertTable = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f60fb752"]]);
const MenuProps = {
  //菜单栏配置
  config: {
    type: Object,
              ...
              },
              {
                ...
                layer: (data2) => h(Colors, {
                  ...
                  onChange: (val) => {
                    ...
                    const btn = itemInstance.proxy.$refs.btn;
                    btn.show = false;
                  }
                })
              }
                ...
                Button,
                {
                  ...
                  onLayerShow: () => {
                    if (typeof configuration.onLayerShow == "function") {
                      configuration.onLayerShow.apply(instance.proxy, [itemProps.name, itemInstance.proxy.$refs.btn]);
                    }
                  },
                  onLayerShown: () => {
                    if (typeof configuration.onLayerShown == "function") {
                      configuration.onLayerShown.apply(instance.proxy, [itemProps.name, itemInstance.proxy.$refs.btn]);
                    }
                  },
                  onLayerHidden: () => {
                    if (typeof configuration.onLayerHidden == "function") {
                      configuration.onLayerHidden.apply(instance.proxy, [itemProps.name, itemInstance.proxy.$refs.btn]);
                    }
                  },
                  onOperate: (name, val) => {
                    if (typeof configuration.onOperate == "function") {
                      configuration.onOperate.apply(instance.proxy, [name, val, itemInstance.proxy.$refs.btn]);
                    }
                  }
                },
                {
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7f1a4243"]]);
const EditifyProps = {
  //编辑器内容
  modelValue: {
    type: String,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const emits = __emit;
    const $editTrans = inject("$editTrans");
    const $editLocale = inject("$editLocale");
    ...
    const toolbarConfig = computed(() => {
      return mergeObject(getToolbarConfig($editTrans, $editLocale), props.toolbar || {});
    });
    const menuConfig = computed(() => {
      return mergeObject(getMenuConfig($editTrans, $editLocale), props.menu || {});
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["editify", { fullscreen: isFullScreen.value, autoheight: _ctx.autoheight }]),
        ref_key: "elRef",
        ref: elRef
      }, [
...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-09595cda"]]);
const en_US = {
  textWrapUp: "Up feed",
