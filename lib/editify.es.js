...
const InsertImage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9a30b25f"]]);
...
const InsertVideo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-002629ee"]]);
                ...
                Button,
                {
                  ...
                  onLayerShow: () => {
                    if (typeof configuration.onLayerShow == "function") {
                      configuration.onLayerShow.apply(instance.proxy, [itemProps.name, itemInstance.proxy.$refs.btnRef]);
                    }
                  },
                  onLayerShown: () => {
                    if (typeof configuration.onLayerShown == "function") {
                      configuration.onLayerShown.apply(instance.proxy, [itemProps.name, itemInstance.proxy.$refs.btnRef]);
                    }
                  },
                  onLayerHidden: () => {
                    if (typeof configuration.onLayerHidden == "function") {
                      configuration.onLayerHidden.apply(instance.proxy, [itemProps.name, itemInstance.proxy.$refs.btnRef]);
                    }
                  },
                  onOperate: (name, val) => {
                    if (typeof configuration.onOperate == "function") {
                      configuration.onOperate.apply(instance.proxy, [name, val, itemInstance.proxy.$refs.btnRef]);
                    }
                  }
                },
                {
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-11de5472"]]);
const EditifyProps = {
  //国际化语言类型
  locale: {
    type: String,
...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-166580d6"]]);
