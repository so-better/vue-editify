      ...
      for (let i = 0; i < length; i++) {
        ...
        if (blob.type.startsWith("image/")) {
          ...
          if (typeof this.customImagePaste == "function") {
            await this.customImagePaste.apply(this, [url2, useCache]);
          } else {
          ...
          if (typeof this.customVideoPaste == "function") {
            await this.customVideoPaste.apply(this, [url2, useCache]);
          } else {
...
const Toolbar_vue_vue_type_style_index_0_scoped_c50ce85f_lang = "";
const _sfc_main$6 = {
  name: "Toolbar",
  ...
  methods: {
    ...
    setWidth(value) {
      ...
      const element2 = this.$parent.getCurrentParsedomElement("img", this.$parent.canUseCache) || this.$parent.getCurrentParsedomElement("video", true);
      if (element2) {
        const styles = {
          width: value
        };
...
const Toolbar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-c50ce85f"]]);
...
const Menu_vue_vue_type_style_index_0_scoped_6f02f571_lang = "";
const _sfc_main$1 = {
  name: "Menu",
  props: {
    //菜单栏配置
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-6f02f571"]]);
const Editify_vue_vue_type_style_index_0_scoped_bd5784e1_lang = "";
const _sfc_main = {
  name: "editify",
  props: { ...editorProps },
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", {
        ...
        onCopy: _cache[1] || (_cache[1] = (...args) => $options.handleEditorCopy && $options.handleEditorCopy(...args)),
        onCut: _cache[2] || (_cache[2] = (...args) => $options.handleEditorCut && $options.handleEditorCut(...args)),
        onPaste: _cache[3] || (_cache[3] = (...args) => $options.handleEditorPaste && $options.handleEditorPaste(...args)),
        onClick: _cache[4] || (_cache[4] = (...args) => $options.handleEditorClick && $options.handleEditorClick(...args)),
        onCompositionstart: _cache[5] || (_cache[5] = ($event) => $data.isInputChinese = true),
        onCompositionend: _cache[6] || (_cache[6] = ($event) => $data.isInputChinese = false),
      ...
      createVNode(_component_Toolbar, {
        ...
        "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => $data.toolbarOptions.show = $event),
...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-bd5784e1"]]);
const iconfont = "";
const en_US = {
  textWrapUp: "Up feed",
