...
const specialInblockHandle = function(editor, element2) {
  if (element2.hasChildren() && !element2.parent) {
    const elements = AlexElement.flatElements(element2.children);
...
const Editify_vue_vue_type_style_index_0_scoped_f0ad6f7c_lang = "";
const _sfc_main = {
  name: "editify",
  props: { ...editorProps },
...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-f0ad6f7c"]]);
const iconfont = "";
const en_US = {
  textWrapUp: "Up feed",
