...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-739656a8"]]);
...
const attachment = (options) => {
  ...
  const plugin = () => {
    return (editifyInstance, color2, editTrans) => {
      return {
        //附件菜单项配置
        menu: {
          sequence: {
        ...
        //找到附件元素点击下载
        updateView: (instance) => {
          const editor = instance.exposed.editor.value;
