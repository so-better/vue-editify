  ...
  if (element2.parsedom == "ol" || element2.parsedom == "ul") {
    if (element2.hasChildren()) {
      element2.children.forEach((el, index) => {
        ...
        editor.addElementAfter(newEl, element2);
      });
    }
    element2.toEmpty();
  }
...
const preHandle = function(editor, element2, highlight2, languages2) {
  if (element2.isBlock() && element2.parsedom == "pre") {
    const marks = {
      "data-editify-element": element2.key
    };
    if (element2.hasMarks()) {
...
const blockToParagraph = function(element2) {
  if (!element2.isBlock()) {
    return;
  }
  element2.marks = null;
...
const blockToList = function(element2, ordered = false) {
...
const blockToTask = function(element2) {
...
const setHeading = (vm, parsedom) => {
  getButtonOptionsConfig(vm.$editTrans, vm.$editLocale).heading.map((item) => {
    return item.value;
  });
  if (vm.editor.range.anchor.isEqual(vm.editor.range.focus)) {
    const block = vm.editor.range.anchor.element.getBlock();
...
const insertCodeBlock = (vm) => {
  const cancelCode = (element2) => {
    let content = "";
    AlexElement.flatElements(element2.children).filter((item) => {
      return item.isText();
    }).forEach((item) => {
  ...
  if (vm.editor.range.anchor.isEqual(vm.editor.range.focus)) {
    ...
    const preElements = vm.dataRangeCaches.list.filter((item) => {
      if (item.element.isBlock()) {
        return item.element.parsedom == "pre";
      }
      return item.element.getBlock().parsedom == "pre";
...
const Toolbar_vue_vue_type_style_index_0_scoped_66a2a32a_lang = "";
const _sfc_main$6 = {
  name: "Toolbar",
  ...
  methods: {
    ...
    selectLanguage(name, value) {
      const pre2 = getCurrentParsedomElement(this.$parent, "pre");
      if (pre2) {
        Object.assign(pre2.marks, {
    ...
    insertParagraphWithPre(type = "up") {
      ...
      if (pre2) {
        ...
        if (type == "up") {
          this.$parent.editor.addElementBefore(paragraph, pre2);
        } else {
          this.$parent.editor.addElementAfter(paragraph, pre2);
        }
    ...
    layerShow() {
      if (this.type == "codeBlock") {
        const pre2 = getCurrentParsedomElement(this.$parent, "pre");
        if (pre2) {
          this.languageConfig.displayConfig.value = pre2.marks["data-editify-hljs"] || "";
        }
...
const Toolbar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-66a2a32a"]]);
...
const InsertImage_vue_vue_type_style_index_0_scoped_62a7dce7_lang = "";
const _sfc_main$4 = {
  name: "InsertImage",
  emits: ["change", "insert"],
  props: {
      ...
      if (filterFiles.length) {
        if (typeof this.customUpload == "function") {
          ...
          for (let i = 0; i < filterFiles.length; i++) {
            const url = await obj.file.dataFileToBase64(filterFiles[i]);
            images.push(url);
          }
          images.forEach((url) => {
...
const InsertImage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-62a7dce7"]]);
const InsertVideo_vue_vue_type_style_index_0_scoped_ab78e94f_lang = "";
const _sfc_main$3 = {
  name: "InsertVideo",
  emits: ["change", "insert"],
  props: {
...
const InsertVideo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-ab78e94f"]]);
...
const Menu_vue_vue_type_style_index_0_scoped_33c8569f_lang = "";
const _sfc_main$1 = {
  name: "Menu",
  props: {
    //菜单栏配置
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-33c8569f"]]);
const Editify_vue_vue_type_style_index_0_scoped_6bd37301_lang = "";
const _sfc_main = {
  name: "editify",
  props: { ...editorProps },
  ...
  methods: {
    ...
    handleToolbar() {
      ...
      this.$nextTick(() => {
        ...
        const pre2 = getCurrentParsedomElement(this, "pre");
        ...
        if (link) {
          ...
          this.toolbarOptions.node = `[data-editify-uid="${this.uid}"] [data-editify-element="${pre2.key}"]`;
          if (this.toolbarOptions.show) {
            this.$refs.toolbar.$refs.layer.setPosition();
          } else {
            this.toolbarOptions.show = true;
...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-6bd37301"]]);
const iconfont = "";
const en_US = {
  textWrapUp: "Up feed",
