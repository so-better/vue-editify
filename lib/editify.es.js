...
const Toolbar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-5df14f7c"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const selectFile = async (e) => {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        const isMatch = props.accept && Array.isArray(props.accept) && props.accept.length ? props.accept.some((item) => {
...
const InsertImage = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-03bae2f5"]]);
...
const InsertVideo = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-46aebf16"]]);
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-67392864"]]);
const EditifyProps = {
  //国际化语言类型
  locale: {
    type: String,
...
const Editify = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-270817aa"]]);
...
const InsertAttachment = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d49c00ca"]]);
const attachment = (options) => {
  const plugin = (editTrans, color2, editor) => {
    const pluginResult = {
      menu: {
        sequence: {
        ...
        extends: {
          attachment: {
            ...
            layer: () => h(InsertAttachment, {
              ...
              onChange: (instance) => {
                instance.$parent.$parent.setPosition();
              },
              onInsert: (url, instance) => {
                ...
                editor.domRender();
                instance.$parent.$parent.$parent.show = false;
              }
            })
          }
        }
